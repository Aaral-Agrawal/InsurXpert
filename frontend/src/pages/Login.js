...
//           const [showMessageBox, setShowMessageBox] = useState(false); // Control message box visibility
...
//             try {
//             // Simulate API request (Replace with your actual backend URL)
//               const response = await fetch("https://your-backend-url.com/submit-claim", {
//               method: "POST",
...
//     setMessage(data.status); // Store the response message
//     setShowMessageBox(true); // Show the popup message
//   } catch (error) {
...
//         <div className="text-center d-flex justify-content-between">
//               <Button variant="secondary" size="lg" onClick={() => navigate("/")}>Cancel</Button>
//               <Button variant="primary" size="lg" onClick={handleSubmitClaim} className="d-flex align-items-center gap-2">
//                 Submit Claim <FaArrowRight />
//               </Button>
//             </div>
//           </Form>
